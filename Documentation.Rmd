...
```{r tenure-distribution-plot, echo=FALSE, fig.cap="Tenure Distribution by Churn Status", fig.align='center', out.width='85%'}
knitr::include_graphics("Plots/tenure_churn_distribution.png")
```
